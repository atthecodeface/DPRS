...
![1d DP evolution for $p=0.53891$, $n_x=1000$, $t=200$](docs/images/lattice_p0p538910_s5_nx1000.png){width=500}
...
![2d DP $t$-decay of mean order parameter $\overline\rho(t)$, for $p=0.163145$, $n_x=30000$, $n_y=30000$, $t=50000$](docs/images/ρmean_p0p163145_s1_nx30000_ny30000.png){width=500}
