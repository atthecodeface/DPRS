...
class Main {
    constructor(logger, params) {
        ...
        params_1d.simsettings.n_iterations = 500;
        params_1d.simsettings.sample_period = 1;
        params_1d.simsettings.random_seed = 1;
        params_1d.dimensions.n_x = 350;
        params_1d.dimensions.n_y = 1;
        params_1d.dimensions.n_z = 1;
        params_1d.simsettings.seed_kind = "random";
        params_1d.simsettings.simulation_kind = "staggered_dk";
        // 0.62 is good
        ...
        params_2d.simsettings.n_iterations = 500;
        params_2d.simsettings.sample_period = 1;
        params_2d.simsettings.random_seed = 6;
        params_2d.dimensions.n_x = 350;
        params_2d.dimensions.n_y = 150;
        params_2d.dimensions.n_z = 1;
        params_2d.simsettings.seed_kind = "edge";
        params_2d.simsettings.simulation_kind = "bedload";
