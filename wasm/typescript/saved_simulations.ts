...
export class SavedSimulations {
  ...
  /**
   * Map from filename to description of the file
   */
  ...
  constructor(
    ...
    if (div === null) {
      ...
      this.log.pop_reason();
      throw new Error(
        `Failed to initialize SavedSimulation div as ${div_id} could not be found in the document`,
      );
    }
