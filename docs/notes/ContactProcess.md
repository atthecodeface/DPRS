...
### The algorithm is roughly:
 ...
 - Make a list of *all* the lattice sites, not just the occupied ones: $\,$ $\mathcal{S}_\textsf{lattice}$
 - Randomize the order of this list: $\,$ $\mathcal{S}_\textsf{lattice} \mapsto \mathcal{S}_\textsf{randomized}$
 ...
 - Loop over $K$ iterations $k \in \{1, \dots, K\}$:
   - Consider the first site in the randomized list $\mathcal{S}_\textsf{randomized}$ and label it $i$ with occupancy $s_i$
