...
### The algorithm is roughly:
 ...
 - Randomize the order of this list into: $\quad {\mathcal{S}}_{\mathsf{lattice}} \rightarrow \mathcal{S}_{\mathsf{randomized}}$
 ...
 - Loop over $K$ iterations $k \in \{1, \dots, K\}$:
   ...
   - Count the number of occupied sites in the neighborhood: $\quad n_i = \sum_{j\in \langle i \rangle} s_j$
   - Compute the _propagation_ rate: $\quad w_i[0 \mapsto 1, n_i] = \lambda n_i/2 d$
